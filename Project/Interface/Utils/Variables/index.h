...
namespace var {
    ...
    extern bool enable_randomization;
    extern float random_tick_skip_pct;
    extern float random_score_noise_pct;
    extern int random_reaction_min_ms;
    extern int random_reaction_max_ms;
    extern float random_overshoot_pct;
    extern bool random_context_aware;
