...
namespace var {
    ...
    float random_tick_skip_pct = 3.f;
    float random_score_noise_pct = 10.f;
    int random_reaction_min_ms = 80;
    int random_reaction_max_ms = 180;
    float random_overshoot_pct = 12.f;
    bool random_context_aware = true;
