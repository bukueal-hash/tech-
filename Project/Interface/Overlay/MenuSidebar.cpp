...
void DrawArcVisCheckContent()
{
    ...
    ArcMenuLayout::Checkbox("Cam POV: Use PendingViewTarget", &var::camPovUsePending);
    ArcMenuHoverTooltip("Toggle between PendingViewTarget (0xCA0..) and live ViewTarget (0x4C8..) camera offsets for debug.");
    ImGui::Separator();
