...
/** Pre-admit margin beyond ESP slider so entities cache before draw edge. */
inline constexpr float kNearRangeMarginM = 15.f;
...
/**
 * Append uncached actors within maxDistM + marginM of cam to probeSet.
 * Scatter-reads roots in 512-key chunks; stops after maxAdds insertions.
 */
...
/** Same as AppendNearRangeUncachedProbes but fills outKeys (ItemList near-first). */
