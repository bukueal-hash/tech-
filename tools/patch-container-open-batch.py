...
# Fix accidental double-escaped newline in log line
text = text.replace('<< "}\\\\n";', '<< "}\\n";')

path.write_text(text, encoding="utf-8")
print("patched ContainerList.cpp OK")
